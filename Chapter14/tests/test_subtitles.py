...
class TestPhrases(TestCase):
    def test_split_phrase(self):
        phrase = libbots.data.Phrase(
            words=["a", "b", "c"], time_start=datetime.timedelta(seconds=0), time_stop=datetime.timedelta(seconds=10)
        )
...
class TestUtils(TestCase):
    def test_parse_time(self):
        self.assertEqual(subtitles.parse_time("00:00:33,074"), datetime.timedelta(seconds=33, milliseconds=74))
