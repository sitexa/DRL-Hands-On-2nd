...
if __name__ == "__main__":
    ...
    parser.add_argument("-ma", "--model_a", required=True, help="Model file to load in the first group")
    parser.add_argument("-mb", "--model_b", required=True, help="Model file to load in the second group")
    ...
    parser.add_argument("--count_a", type=int, default=20, help="Size of the first group, default=100")
    parser.add_argument("--count_b", type=int, default=20, help="Size of the second group, default=100")
    ...
    print("Average reward: A %.3f, B %.3f" % (a_total_reward / args.count_a, b_total_reward / args.count_b))
