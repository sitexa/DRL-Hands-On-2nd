...
if __name__ == "__main__":
    ...
    net = model.DQNModel(obs_size=env.num_fields * params.encoder_size, cmd_size=params.encoder_size)
    net = net.to(device)
    ...
    optimizer = optim.RMSprop(itertools.chain(net.parameters(), prep.parameters()), lr=LEARNING_RATE, eps=1e-5)
